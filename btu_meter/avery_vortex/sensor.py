...
class ConfigLoader:
    ...
    def LoadConfig(self):
        ...
        THIS WILL BE REPLACED WITH PREFERECENCE STORAGE IN ESP 
        """
        try:
    ...
    def editConfig(self, Section, Key, Value):
        """Edit a specific configuration value and save to file"""
        if Section in self.Config and Key in self.Config[Section]:
            ...
            print(f"Invalid config section/key: {Section}/{Key}")
...
class SensorDataPacket:
    ...
    def BuildPacket(self, Frequency, Temp1C, Temp2C):
        ...
        # SEMA compliant packet structure
        # typename, version, pascal case
        # TODO: add as.btu.reading, 000
        Packet = {
            "DeviceId": self.DeviceId, # hardware uid
