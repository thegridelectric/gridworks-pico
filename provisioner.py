...
if __name__ == "__main__":
    ...
    while not connected_to_api:
        ...
        base_url = input("Enter hostname (e.g., 'fir2'): ")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"The message sent from the Pico to the API received a status code {response.status_code}, indicating an issue.")
                print("This issue could come from the API code.")
            response.close()
        except Exception as e:
            print("There was an error connecting to the API. Please check the hostname and try again.")
    ...
    comms_config_content = {
        ...
        "BaseUrl": f"http://{base_url}.local:8000"
    }
